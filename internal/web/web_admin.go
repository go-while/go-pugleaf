...
type AdminPageData struct {
	...
	ReverseProxyIPHeader          string                                // Header the client IP is taken from ("" = X-Forwarded-For)
	...
	FormFieldReverseProxyIPHeader string                                // Reverse proxy client IP header form field name
